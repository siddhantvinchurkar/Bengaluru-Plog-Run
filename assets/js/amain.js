...
window.onload = function(){
		...
		// Sort array
		ambassadorArray.sort(function(x, y){
			x = x.substring(x.indexOf('_name">') + 1, x.indexOf('<', x.indexOf('_name">')));
			y = y.substring(y.indexOf('_name">') + 1, y.indexOf('<', y.indexOf('_name">')));
			x = x.substring(6);
			y = y.substring(6);
